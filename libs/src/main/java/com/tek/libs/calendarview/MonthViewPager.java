...
public class MonthViewPager extends ViewPager {
    ...
    public class MonthViewPagerAdapter extends PagerAdapter {
         ...
         * @return
         */
        public int getYearAdapter(int position){
            return (position + mDelegate.getMinYearMonth() - 1) / 12 + mDelegate.getMinYear();
        }
         ...
         * @return
         */
        public int getMonthAdapter(int position){
            return  (position + mDelegate.getMinYearMonth() - 1) % 12 + 1;
        }
